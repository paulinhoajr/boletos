...
namespace Paulinhoajr\Boletos\Cnab\Remessa\Cnab240\Banco;

use Paulinhoajr\Boletos\CalculoDV;
use Paulinhoajr\Boletos\Cnab\Remessa\Cnab240\AbstractRemessa;
use Paulinhoajr\Boletos\Contracts\Boleto\Boleto as BoletoContract;
use Paulinhoajr\Boletos\Contracts\Cnab\Remessa as RemessaContract;
...
class Bancoob extends AbstractRemessa implements RemessaContract
{
    ...
    const PROTESTO_DIAS_CORRIDOS = '7';
    const PROTESTO_DIAS_UTEIS = '2';
    const PROTESTO_NAO_PROTESTAR = '1';
    ...
    protected function segmentoP(BoletoContract $boleto)
    {
        ...
        //dd($boleto->getStatus(), $boleto::STATUS_BAIXA, $boleto::STATUS_ALTERACAO);

        if ($boleto->getStatus() == $boleto::STATUS_BAIXA) {
            //dd(self::OCORRENCIA_PEDIDO_BAIXA);
...
//self::PROTESTO_NAO_PROTESTAR - 1
// //self::PROTESTO_DIAS_UTEIS - 2
// //$boleto->getDiasProtesto()- 5
        ...
        //dd(Util::formatCnab('9', $boleto->getDiasProtesto(), 2));
